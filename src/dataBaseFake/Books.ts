...
export const BOOKS_OCASO = [
	...
	{ date: "700.000", 
		...
		description: "En un Imperio donde crear vida es una herejía, el genetista Betho recibe la misión de terraformar planetas mediante criaturas diseñadas para sobrevivir a cualquier entorno.", 
		img: amalgama},
		]
	},
	{ date: "700.002", books: [
		...
		labels: ["Ciencia Ficcion", "Mutantes"],
		saga: "",  
		description: "Betho intenta continuar su vida, cayendo en las reptantes acciones de los Sormiess quienes le han pedido repetir su error nuevamente." },
	]},
	{ date: "700.002", books: [
		{ title: "La Ultima",
		icon: "libro",
	...
	{ date: "700.200", books: [
		...
		labels: ["Genesis"],
		saga: "",  
		description: "Historia de trasfondo sobre los Pan Agon Glin y sus creencias." },
	]},
	{ date: "700.302", books: [
	...
	{ date: "700.314", books: [
		...
		description: "El trabajo de Lar-ry le lleva a comprar implantes que le permiten pensar con libertad y comprender el mundo a su alrededor. Esto le trae el peso de la libertad, donde el y su gente solo son inferiores en una galaxia mucho mas oscuridad de lo que el creía.",
		img: elLider
	},
	]},
];